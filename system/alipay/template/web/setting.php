     ...
     <form method="post" class="form-horizontal" enctype="multipart/form-data" >
		<h3 class="header smaller lighter blue">服务窗设置</h3>
		  ...
		  <div class="form-group">
										...
										<div class="col-sm-9">
										     <input type="text" name="alipay_name" class="col-xs-10 col-sm-4" value="<?php  echo $settings['alipay_name'];?>" />&nbsp&nbsp;&nbsp;<a href="http://bbs.yuancloud.cn/forum-36-1.html" target="_blank" style="font-size:16px"><strong>配置帮助</strong></a>
										</div>
									</div>
