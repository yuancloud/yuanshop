...
<head>
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
		<title><?php  echo empty($settings['shop_title'])?'YuanShop':$settings['shop_title'];?></title>
		<link rel="shortcut icon" href="favicon.ico" type="image/x-icon" />
		<meta name="description" content="<?php  echo empty($settings['shop_description'])?'YuanShop':$settings['shop_description'];?>" />
		<meta name="keywords" content="<?php  echo empty($settings['shop_keyword'])?'YuanShop':$settings['shop_keyword'];?>">
...
<div class="navbar-header pull-left">
    <a href="#" class="navbar-brand">
        <small>
            <i class="icon-leaf"></i>
            <span id='accountname'><?php  echo empty($settings['shop_title'])?'YuanShop':$settings['shop_title'];?></span>
        </small>
    </a><!-- /.brand -->
</div><!-- /.navbar-header -->
...
<ul class="nav ace-nav" style="height:45px">
	<li class="Larger">
    <a class="dropdown-toggle"  href="http://bbs.yuancloud.cn" target="_blank">
  ...
  <?php if (in_array("member-list",$menurule)) { ?> 
                                       ...
                                       <li>
                                        ...
                                        <?php  echo $menu['title'] ?>                                    
                                   		...
                                   		<?php
                                             ...
                                             <?php  if($showdownload) { ?>
                                   	      <li>
                                   	      	   <a onclick="navtoggle('互相营销管理 - > 点击下载互动插件')" href="http://addons.yuancloud.cn/" target="_blank" >     
                                         <i class="icon-double-angle-right"></i>
                                        	点击下载互动插件                             
                                    </a>
                                </li>
                  ...
                  <i class="icon-double-angle-right"></i>
                    ...
                    <ul class="submenu">
                       ...
                       <?php }?>
                                   ...
                                   <?php $yuanshop_addons=array('addon6'=>array('title'=>'数据报表','icon'=>'icon-bar-chart'),
    ...
    <li>
                    ...
                    <ul class="submenu">
                     ...
                     if(is_array($yuanshop_addons)) { foreach($yuanshop_addons as $index=>$module) { 
                     if(!empty($module)){
                      ?>     
                                     <li>
                    <!-- 导航第一级 -->
  ...
  <?php if (in_array("user-user",$menurule)) { ?> 
    ...
    <li>
                    ...
                    <ul class="submenu">
                                    ...
                                    <!--  <li>
                                          <a onclick="navtoggle('系统管理 - > 插件扩展')" href="http://addons.yuancloud.cn/" target="_blank" >                              
                                        <i class="icon-double-angle-right"></i>
                                        插件扩展                                      
                                    </a>
                                </li>  -->   <li>
