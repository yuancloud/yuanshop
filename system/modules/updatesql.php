...
{
	$sql =$sql."
	delete from `yuanshop_rule` where `modname`='weixin' and `moddo`='weixin';
insert into `yuanshop_rule` (`moddescription`,`modname`,`moddo`)value('微信设置','weixin','weixin');
	";
...
{
	$sql =$sql."
	delete from `yuanshop_rule` where `modname`='alipay' and `moddo`='alipay';
	insert into `yuanshop_rule` (`moddescription`,`modname`,`moddo`)value('支付宝服务窗设置', 'alipay', 'alipay');
	";
		$user_list = mysqld_selectall("SELECT * FROM " . table('user') );
	foreach ($user_list as &$_tuser) {
...
{
	$sql =$sql."
	delete from `yuanshop_rule` where `modname`='bonus' and `moddo`='bonus';
insert into `yuanshop_rule` (`moddescription`,`modname`,`moddo`)value('促销管理','bonus','bonus');
	";
	$user_list = mysqld_selectall("SELECT * FROM " . table('user') );
	foreach ($user_list as &$_tuser) {
...
$sql = $sql."
update `yuanshop_shop_order` set paytype=1 where paytypecode='gold';
update `yuanshop_shop_order` set paytype=3 where paytypecode='delivery';
update `yuanshop_shop_order` set paytype=2 where paytypecode='weixin';
update `yuanshop_shop_order` set paytype=2 where paytypecode='alipay';
update `yuanshop_shop_order` set paytype=2 where paytypecode='bank';
...
CREATE TABLE IF NOT EXISTS  `yuanshop_shop_goods_comment` (
  `createtime` int(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS  `yuanshop_shop_pormotions` (
...
CREATE TABLE IF NOT EXISTS  `yuanshop_gold_teller` (
  `createtime` int(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `yuanshop_gold_order` (
  `createtime` int(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `yuanshop_shop_diymenu` (
...
CREATE TABLE IF NOT EXISTS `yuanshop_rank_model` (
...
CREATE TABLE IF NOT EXISTS `yuanshop_rank_phb` (
...
CREATE TABLE IF NOT EXISTS `yuanshop_bonus_type` (
...
CREATE TABLE IF NOT EXISTS `yuanshop_bonus_user` (
...
CREATE TABLE IF NOT EXISTS `yuanshop_bonus_good` (
...
CREATE TABLE IF NOT EXISTS `yuanshop_alipay_rule` (
...
CREATE TABLE IF NOT EXISTS `yuanshop_alipay_alifans` (
...
CREATE TABLE IF NOT EXISTS `yuanshop_shop_dispatch_area` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `yuanshop_dispatch` (
