...
<link rel="stylesheet" href="http://localhost:32185/themes/default/__RESOURCE__/login/css/bootstrap.min.css">
<link rel="stylesheet" href="http://localhost:32185/themes/default/__RESOURCE__/login/css/font-awesome.min.css">
<style>
...
<div style="padding-left: 0.6em;  padding-right: 0.6em;">
  	<strong>使用合作账号登录</strong>  	<p>
    	<a href="<?php echo create_url('mobile',array('name' => 'shopwap','do' => 'third_loginqq'));?>"><img src="http://localhost:32185/themes/default/__RESOURCE__/login/images/qq.png"></a>
    </p>
  </div>
				  <?php } ?>
  <?php } ?>
